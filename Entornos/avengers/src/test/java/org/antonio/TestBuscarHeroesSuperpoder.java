...
public class TestBuscarHeroesSuperpoder {
    @Test
    public void testBuscarHeroesSuperpoder() throws HeroeNoEncontradoException {
        ...
        List<Heroe> her = new ArrayList<>();
        her.add(capitanAmerica);
        her.add(spiderman);
        her.add(ironman);

        assertArrayEquals(her.toArray(), gh.ListaHeroesPorSuperpoder("rapido").toArray());
        assertTrue(her.toArray().length > gh.ListaHeroesPorSuperpoder("maquina").toArray().length);
